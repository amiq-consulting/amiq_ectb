...
static void print_normal(const string &text, ostream &stream) {
  stream << text ;
}
...
//    cout << "BIN NAME: " << name << "\n";
  ...
  // this is where we print HITCOUNT
    hit_count = (int) coverdata.data.int64;
 /*  if (hit_count > 0){
      cout << "\033[1m\033[32m" << "BINS THAT WERE HIT\n\n" << "\033[0m";
      cout << "BIN's " << name << " HITCOUNT: " << hit_count << endl << endl;
    }
    else {
      cout << "\033[1m\033[31m" << "BINS THAT WERE NOT HIT\n\n" << "\033[0m";
      cout << name << endl << " HITCOUNT: " << hit_count << endl << endl;;
    }
*/
